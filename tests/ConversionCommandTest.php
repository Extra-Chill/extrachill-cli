...
namespace {
	$conversion_command_test_wp_bootstrapped = function_exists( 'get_user_by' );

	if ( ! $conversion_command_test_wp_bootstrapped ) {
		...
		// instead: `php tests/ConversionCommandTest.php` (see homeboy.json self_checks).
