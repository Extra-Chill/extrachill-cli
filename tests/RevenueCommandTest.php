...
namespace {
	$revenue_command_test_wp_bootstrapped = function_exists( 'get_user_by' );

	if ( ! $revenue_command_test_wp_bootstrapped ) {
		...
		// instead: `php tests/RevenueCommandTest.php` (see homeboy.json self_checks).
