...
namespace {
	$concert_tracking_wp_bootstrapped = function_exists( 'get_user_by' );

	if ( ! $concert_tracking_wp_bootstrapped ) {
		...
		// instead: `php tests/ConcertTrackingCommandTest.php` (see homeboy.json self_checks).
