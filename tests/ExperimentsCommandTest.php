...
namespace {
	$experiments_command_test_wp_bootstrapped = function_exists( 'get_user_by' );

	if ( ! $experiments_command_test_wp_bootstrapped ) {
		...
		// instead: `php tests/ExperimentsCommandTest.php` (see homeboy.json self_checks).
