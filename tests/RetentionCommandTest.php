...
namespace {
	$retention_command_test_wp_bootstrapped = function_exists( 'get_user_by' );

	if ( ! $retention_command_test_wp_bootstrapped ) {
		...
		// instead: `php tests/RetentionCommandTest.php` (see homeboy.json self_checks).
