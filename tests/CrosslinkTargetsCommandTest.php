...
namespace {
	$crosslink_targets_test_wp_bootstrapped = function_exists( 'get_user_by' );

	if ( ! $crosslink_targets_test_wp_bootstrapped ) {
		...
		// instead: `php tests/CrosslinkTargetsCommandTest.php` (see homeboy.json self_checks).
