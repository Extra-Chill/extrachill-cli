...
namespace {
	$health_command_wp_bootstrapped = function_exists( 'get_user_by' );

	if ( ! $health_command_wp_bootstrapped ) {
		...
		// instead: `php tests/HealthCommandTest.php` (see homeboy.json self_checks).
