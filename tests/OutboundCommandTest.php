...
namespace {
	$outbound_command_test_wp_bootstrapped = function_exists( 'get_user_by' );

	if ( ! $outbound_command_test_wp_bootstrapped ) {
		...
		// instead: `php tests/OutboundCommandTest.php` (see homeboy.json self_checks).
