...
namespace {
	$summary_command_test_wp_bootstrapped = function_exists( 'get_user_by' );

	if ( ! $summary_command_test_wp_bootstrapped ) {
		...
		// instead: `php tests/SummaryCommandTest.php` (see homeboy.json self_checks).
