...
namespace {
	...
	$owner_site_wp_bootstrapped = function_exists( 'get_user_by' );

	if ( ! $owner_site_wp_bootstrapped ) {
		...
		// instead: `php tests/OwnerSiteAbilityTest.php` (see homeboy.json self_checks).
