...
### Added
- add wp extrachill network regenerate-og-card

## [0.33.2] - 2026-09-22

### Changed
- skip revenue runtime assertions when no wp binary is reachable

## [0.33.1] - 2026-09-22

### Changed
- guard standalone WordPress doubles against the managed PHPUnit harness

## [0.33.0] - 2026-09-21

### Added
- expose Link Page storage migration
...
### Fixed
- drop the negative enumeration disclaimer from AGENTS.md

## [0.32.8] - 2026-08-22

### Fixed
- label raw and trustworthy analytics counts

## [0.32.7] - 2026-08-19

### Fixed
- read nested compact queue summary

## [0.32.6] - 2026-08-19

### Fixed
- scope platform health errors to network
- read live queue summary shape

## [0.32.5] - 2026-08-10

### Changed
- use owner-site ability bootstrap

### Fixed
- clear full release lint gate
- scope platform queue health to bootstrap site

## [0.32.4] - 2026-07-27

### Changed
- make CLI agent guidance intent-based

## [0.32.3] - 2026-07-20

### Fixed
- make concert commands state-safe

## [0.32.2] - 2026-07-18

### Fixed
- consume experiment owner envelope

## [0.32.1] - 2026-07-18

### Fixed
- omit input for no-schema experiment abilities
